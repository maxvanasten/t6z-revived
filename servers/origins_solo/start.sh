...
readonly SERVER_NAME="zm_tomb_solo"
...
readonly SERVER_KEY="ZnLa2uDvh1Q254zwzmCAS7oesvbTe2lR"
...
readonly CONFIG_FILE="zm_tomb_solo.cfg"

# The UDP port your server will listen on
readonly SERVER_PORT=21890
...
readonly MOD="mods/zm_origins_solo"
...
start_server() {
    ...
    echo "[$timestamp] Server $SERVER_NAME will load $CONFIG_FILE and listen on port $SERVER_PORT UDP! ($SERVER_KEY)"
